...
└── src
    ...
    ├── components # All application's components are listed here.
    │   ├── Books.js # A component for listing diffrent books.
    │   ├── ListBooks.js # The main page componenet.
    │   └── SearchBooks.js # The search page componenet.
